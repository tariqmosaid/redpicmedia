    ...
    var axilInit = {
        ...
        axilMasonary: function () {
            $('.axil-isotope-wrapper').imagesLoaded(function () {
                ...
                var filterValue = $('.isotope-button .is-checked').attr('data-filter');
                // init Isotope
...
$(document).on("click","#menu-mobile",function() {
    $('.mainmenu-nav').addClass('offcanvas show');
    $('.mainmenu-nav').css('visibility','visible');
    $('.header-main-nav').append('<div class="offcanvas-backdrop fade show"></div>');
});
  
$(document).on("click","#menu-mobile-close, .offcanvas-backdrop.show",function() {
    $('.mainmenu-nav').removeClass('offcanvas show');
    $('.mainmenu-nav').css('visibility','invisible');
